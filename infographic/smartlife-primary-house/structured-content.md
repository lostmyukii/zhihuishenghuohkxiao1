...
- Subject: 一间学习房 + 客厅中控 + 玄关的小屋，中央放 N16R8，连到书桌灯、风扇、窗帘、OLED、PIR
...
- "光线暗自动开学习灯，温度高自动开风扇，噪声高短提醒。"
- "灯自动亮，风扇自动转，页面显示触发原因"

**Visual Element**:

- Type: task card
- Subject: 光线暗 -> 学习灯亮；温度高 -> 风扇转；噪声高 -> 蜂鸣短提醒
...
**Key Concept**: 节能响应要说明为什么关灯、关风扇或调整状态。

**Content**:

- "节能响应 | 在合适时机关掉或切换到节能状态，解释为什么省电。"
- "无人或光照充足时关闭灯和风扇，网页显示节能分与节能原因。"
- "节能模式下：无人或光照足时关闭灯/风扇，并显示节能原因。"

**Visual Element**:

- Type: task card
- Subject: PIR 无人、太阳充足、灯/风扇关闭、节能分上升
